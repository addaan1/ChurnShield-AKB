...
<nav class="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-b border-slate-200 dark:border-slate-800">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-8">
            <a href="#problem" class="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Masalah</a>
            <a href="#features" class="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Fitur</a>
            <a href="#methodology" class="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Metodologi</a>
            <a href="#team" class="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Tim</a>
    ...
    <div id="mobileMenu" class="hidden md:hidden px-6 pb-4 space-y-2">
        <a href="#problem" class="block px-4 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800">Masalah</a>
        <a href="#features" class="block px-4 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800">Fitur</a>
        <a href="#methodology" class="block px-4 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800">Metodologi</a>
        <a href="#team" class="block px-4 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800">Tim</a>
...
<section class="relative min-h-screen flex items-center overflow-hidden pt-20 hero-gradient light-hero-gradient dark:hero-gradient">
    <div class="absolute inset-0 grid-pattern opacity-50"></div>

    <div class="absolute top-20 right-10 w-72 h-72 bg-indigo-500/10 rounded-full blur-3xl floating"></div>
    <div class="absolute bottom-20 left-10 w-96 h-96 bg-sky-500/10 rounded-full blur-3xl floating" style="animation-delay: 1.5s;"></div>

    <div class="relative z-10 max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-12 items-center">
        <div>
            <div data-aos="fade-right" data-aos-duration="600" class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-sm font-medium mb-6">
            ...
            <h1 data-aos="fade-right" data-aos-duration="800" class="font-display text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white mb-6 leading-tight">
                Prediksi <span class="gradient-text">Customer Churn</span> dengan Machine Learning
            </h1>

            <p data-aos="fade-right" data-aos-duration="800" data-aos-delay="200" class="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-lg">
        ...
        <div data-aos="fade-left" data-aos-duration="1000" class="hidden lg:block">
            <div class="dashboard-mockup relative">
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl shadow-indigo-500/20 border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <div class="flex items-center gap-2 px-4 py-3 bg-slate-100 dark:bg-slate-700/50 border-b border-slate-200 dark:border-slate-600">
                        <div class="w-3 h-3 rounded-full bg-red-400"></div>
                        <div class="w-3 h-3 rounded-full bg-amber-400"></div>
                        <div class="w-3 h-3 rounded-full bg-emerald-400"></div>
                        <span class="ml-3 text-xs text-slate-500 dark:text-slate-400">churnshield.app/dashboard</span>
                    </div>

                    <div class="p-4 space-y-4">
                        <div class="grid grid-cols-4 gap-3">
                            <div class="p-3 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20">
                                <div class="text-xs text-slate-500 dark:text-slate-400 mb-1">Total</div>
                                <div class="text-lg font-bold text-indigo-600 dark:text-indigo-400">10,000</div>
                            </div>
                            <div class="p-3 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20">
                                <div class="text-xs text-slate-500 dark:text-slate-400 mb-1">Churn</div>
                                <div class="text-lg font-bold text-red-500">2,037</div>
                            </div>
                            <div class="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20">
                                <div class="text-xs text-slate-500 dark:text-slate-400 mb-1">Setia</div>
                                <div class="text-lg font-bold text-emerald-500">7,963</div>
                            </div>
                            <div class="p-3 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20">
                                <div class="text-xs text-slate-500 dark:text-slate-400 mb-1">Rate</div>
                                <div class="text-lg font-bold text-amber-500">20.4%</div>
                            </div>
                        </div>

                        <div class="grid grid-cols-2 gap-3">
                            <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600">
                                <div class="text-xs text-slate-500 dark:text-slate-400 mb-2">Churn per Negara</div>
                                <div class="space-y-2">
                                    <div>
                                        <div class="flex justify-between text-xs mb-1">
                                            <span class="text-slate-600 dark:text-slate-300">France</span>
                                            <span class="font-semibold">16.2%</span>
                                        </div>
                                        <div class="h-1.5 rounded-full bg-slate-200 dark:bg-slate-600">
                                            <div class="h-1.5 rounded-full bg-indigo-500" style="width: 16.2%"></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="flex justify-between text-xs mb-1">
                                            <span class="text-slate-600 dark:text-slate-300">Germany</span>
                                            <span class="font-semibold text-red-500">32.4%</span>
                                        </div>
                                        <div class="h-1.5 rounded-full bg-slate-200 dark:bg-slate-600">
                                    ...
                                    <div>
                                        <div class="flex justify-between text-xs mb-1">
                                            <span class="text-slate-600 dark:text-slate-300">Spain</span>
                                            <span class="font-semibold">16.5%</span>
                                        </div>
                                        <div class="h-1.5 rounded-full bg-slate-200 dark:bg-slate-600">
                            ...
                            <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600">
                                <div class="text-xs text-slate-500 dark:text-slate-400 mb-2">Model Terbaik</div>
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <div>
                                        <div class="text-sm font-semibold">XGBoost</div>
                                        <div class="text-xs text-slate-500 dark:text-slate-400">F1: 94.1%</div>
                                    </div>
                                </div>
                                <div class="space-y-1.5">
                                    <div class="h-1.5 rounded-full bg-slate-200 dark:bg-slate-600">
                                        <div class="h-1.5 rounded-full gradient-bg" style="width: 97.5%"></div>
                                    </div>
                                    <div class="h-1.5 rounded-full bg-slate-200 dark:bg-slate-600">
                                        <div class="h-1.5 rounded-full gradient-bg" style="width: 91.6%"></div>
                                    </div>
                                    <div class="h-1.5 rounded-full bg-slate-200 dark:bg-slate-600">
                                        <div class="h-1.5 rounded-full gradient-bg" style="width: 96.8%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<section id="problem" class="py-24 bg-white dark:bg-slate-900">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            ...
            <h2 data-aos="fade-up" data-aos-delay="100" class="font-display text-4xl md:text-5xl font-bold mb-4">
                Mengapa Keputusan <span class="gradient-text">Sering Gagal?</span>
            </h2>
            <p data-aos="fade-up" data-aos-delay="200" class="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div data-aos="fade-up" data-aos-delay="100" class="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Asumsi yang Salah</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Keputusan dibangun dari intuisi manajemen, bukan bukti empiris dari pola data nasabah.</p>
            </div>

            <div data-aos="fade-up" data-aos-delay="200" class="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Perubahan Perilaku</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Preferensi dan loyalitas nasabah terus bergeser sehingga keputusan yang dahulu tepat menjadi usang.</p>
            </div>

            <div data-aos="fade-up" data-aos-delay="300" class="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Keterbatasan Sumber Daya</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Anggaran retensi terbatas dan harus diarahkan pada segmen berisiko tinggi, bukan disebar merata.</p>
            </div>

            <div data-aos="fade-up" data-aos-delay="400" class="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Minim Validasi Data</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Tanpa pengujian model dan metrik yang jelas, dampak keputusan tidak terukur dan sulit dipertanggungjawabkan.</p>
            </div>
        </div>
    </div>
</section>

<section id="features" class="py-24 bg-slate-50 dark:bg-slate-800/50">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div data-aos="zoom-in" data-aos-delay="100" class="group p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Ringkasan KPI</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Total nasabah, churn rate, dan metrik kunci dalam kartu ringkas.</p>
            </div>

            <div data-aos="zoom-in" data-aos-delay="200" class="group p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Analisis Demografis</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Distribusi churn per geografi, usia, dan gender dengan filter interaktif.</p>
            </div>

            <div data-aos="zoom-in" data-aos-delay="300" class="group p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Analisis Perilaku</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Churn terhadap keaktifan, kepemilikan produk, dan kartu kredit.</p>
            </div>

            <div data-aos="zoom-in" data-aos-delay="400" class="group p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold text-lg mb-2">Prediksi Churn</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Simulasi prediksi probabilitas churn berdasarkan input data nasabah.</p>
            </div>
        </div>
    </div>
</section>

<section id="methodology" class="py-24 bg-white dark:bg-slate-900">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
        ...
        <div class="relative">
            ...
            <div class="grid lg:grid-cols-5 gap-8">
                <div data-aos="fade-up" data-aos-delay="100" class="relative text-center">
                    ...
                    <h3 class="font-display font-semibold text-lg mb-2">Pengumpulan Data</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Memuat dataset Bank Churn dari Kaggle (10.000 nasabah).</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200" class="relative text-center">
                    ...
                    <h3 class="font-display font-semibold text-lg mb-2">Preprocessing</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Encoding kategorikal dan scaling variabel numerik.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="300" class="relative text-center">
                    ...
                    <h3 class="font-display font-semibold text-lg mb-2">Eksplorasi Data</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Analisis pola churn berdasarkan geografi, usia, dan perilaku.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="400" class="relative text-center">
                    ...
                    <h3 class="font-display font-semibold text-lg mb-2">Pemodelan</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Melatih 3 model dan evaluasi dengan 4 metrik.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="500" class="relative text-center">
                    ...
                    <h3 class="font-display font-semibold text-lg mb-2">Rekomendasi</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Menerjemahkan hasil model menjadi aksi bisnis konkret.</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="team" class="py-24 bg-slate-50 dark:bg-slate-800/50">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            ...
            <p data-aos="fade-up" data-aos-delay="200" class="text-lg text-slate-500 dark:text-slate-400">
                Analisis Keputusan Bisnis
            </p>
        </div>

        <div class="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
            <div data-aos="flip-up" data-aos-delay="100" class="text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold">Sahrul Adicandra E.</h3>
            ...
            <div data-aos="flip-up" data-aos-delay="200" class="text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold">Raihan Naufal S.</h3>
            ...
            <div data-aos="flip-up" data-aos-delay="300" class="text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold">Aflah Zein J.</h3>
            ...
            <div data-aos="flip-up" data-aos-delay="400" class="text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold">Muhammad Ilham G.</h3>
            ...
            <div data-aos="flip-up" data-aos-delay="500" class="text-center p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 card-hover">
                ...
                <h3 class="font-display font-semibold">M. Faizal Aprilianto</h3>
...
<section class="py-24 bg-white dark:bg-slate-900">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 data-aos="fade-up" class="font-display text-4xl md:text-5xl font-bold mb-6">
            Siap Mengeksplorasi <span class="gradient-text">Data?</span>
        </h2>
        <p data-aos="fade-up" data-aos-delay="100" class="text-lg text-slate-500 dark:text-slate-400 mb-10">
        ...
        <div data-aos="fade-up" data-aos-delay="200" class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="{{ route('dashboard.predict') }}" class="px-8 py-4 rounded-xl border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 font-semibold text-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-all hover:-translate-y-1">
                Coba Prediksi Churn
            </a>
        </div>
    </div>
