...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
            ...
            <h3 class="text-2xl font-display font-bold text-red-500">26.9%</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Churn rate hampir 2x lipat nasabah aktif (14.3%)</p>
        </div>
        ...
        <div class="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
            ...
            <h3 class="text-2xl font-display font-bold text-amber-500">82.7%</h3>
        ...
        <div class="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
            ...
            <h3 class="text-2xl font-display font-bold text-red-500">100%</h3>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Nasabah tidak aktif churn 26.9%, hampir 2x lipat nasabah aktif (14.3%). Keaktifan adalah faktor yang bisa langsung dipengaruhi bank.</p>
                </div>
            </div>
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Nasabah dengan 3 produk churn 82.7% dan 4 produk mencapai 100%. Evaluasi pengalaman nasabah multi-produk sangat diperlukan.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    plotOptions: {
        pie: {
            donut: {
                labels: {
                    show: true,
                    total: { show: true, label: 'Total', color: textColor, formatter: () => '10,000' }
                }
            }
        }
    },
